...
- 📌 **[Comment j'ai monté mon VPS Hetzner de zéro sans savoir coder](/blog/comment-jai-configure-mon-vps)** Le point de départ de toute cette stack.
- 📌 **[Prompt Engineering pour Makers : les 5 instructions qui changent tout](/blog/prompt-engineering-makers-system-prompt)** Aller plus loin dans l'optimisation des System Prompts.
