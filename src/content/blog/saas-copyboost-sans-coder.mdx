...
import copyboostScore from '../../assets/copyboost-score.webp';
import copyboostAnalyse from '../../assets/copyboost-analyse.webp';
...
<Image src={copyboostScore} alt="Copyboost score analyse framework persuasif copywriting" width={1280} height={720} loading="lazy" style="width:100%; border-radius:12px; margin:1.5rem 0;" />
...
<Image src={copyboostAnalyse} alt="Copyboost analyse avant après texte marketing conversion" width={1280} height={720} loading="lazy" style="width:100%; border-radius:12px; margin:1.5rem 0;" />
