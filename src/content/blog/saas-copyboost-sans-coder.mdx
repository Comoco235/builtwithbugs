...
6 mois. Des dizaines de bugs. Des nuits à déboguer des webhooks Stripe qui ne fonctionnaient pas et à [configurer mon serveur VPS](/blog/comment-jai-configure-mon-vps) pour automatiser des tâches, des emails de confirmation qui pointaient vers localhost, des crashs silencieux qui rendaient l'app blanche sans explication.
...
La distribution est le vrai défi, surtout avec [les nouvelles règles de l'AEO et du SEO](/blog/comment-maitriser-aeo-2026). Pas la technique. Pas le produit. Trouver les personnes qui ont le problème que tu résous et leur faire découvrir ta solution c'est là que tout se joue.
